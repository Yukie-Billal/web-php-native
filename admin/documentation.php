...
$doc_config = get_documentation_config($mysqli);
$doc_items = get_documentation_items($mysqli);
...
<main class="app-main">
   <?php
   $breadcrumb_title = "Documentation";
   $breadcrumb_active_page = "Documentation";
   $breadcrumb_pre_title = "Documentation";
            ...
            <div class="col-12">
               <div class="card mb-4">
                  <div class="card-header">
                     <h3 class="card-title">Konfigurasi halaman dokumentasi</h3>
                  </div>
                  <div class="card-body">
                     <form class="row gap-3" id="form-update-config">
                        <input type="text" name="id" id="id" value="<?= $doc_config['id'] ?>" hidden>
                        <div class="form-group">
                           <label for="page_title">Judul halaman</label>
                           <input type="text" name="page_title" id="page_title" placeholder="Judul halaman ..." class="form-control" value="<?= $doc_config['page_title'] ?>">
                        </div>
                        <div class="form-group">
                           <label for="page_button_text">Teks tombol halaman </label>
                           <input type="text" name="page_button_text" id="page_button_text" placeholder="Teks tombol ..." class="form-control" value="<?= $doc_config['page_button_text'] ?>">
                        </div>
                        <div class="form-group">
                           <label for="section_title">Judul bagian konten</label>
                           <input type="text" name="section_title" id="section_title" placeholder="Judul bagian konten ..." class="form-control" value="<?= $doc_config['section_title'] ?>">
                        </div>
                        <div class="form-group">
                           <label for="section_subtitle">Subjudul bagian konten</label>
                           <textarea name="section_subtitle" id="section_subtitle" class="form-control" rows="3"><?= $doc_config['section_subtitle'] ?></textarea>
                        </div>
                        <div>
         ...
         <div class="row">
            <div class="col-12 col-md-8">
               <div class="card mb-4">
                  ...
                  <div class="card-body">
                     <div class="row">
                        <?php foreach ($doc_items as $key => $d): ?>
...
<script>
   ...
   formElement.addEventListener("submit", (e) => {
      ...
      fetch("action/update_doc_config.php", {
         method: "POST",
         body: form
      }).then(async res => {
